...
public class SemanticAnalyzer implements AbsynVisitor {
    ...
    //     // Initialize the global scope or similar actions
    //     symbolTable.enterScope(level);
    //     symbolTable.insert("input", new NodeType("input", new FunDec(0, 0, new NameTy(0, 0, 1), "input", null, null), 0));
    //     symbolTable.insert("output", new NodeType("output", new FunDec(1, 0, new NameTy(0, 0, 2), "output", null, null), 0));

    //     if (program.declarations != null) {
    //         program.declarations.accept(this, level + 1, isAddr);
    //     }
    //     symbolTable.exitScope(level);
    //     symbolTable.printAllScopes(); // Print the symbol table before exiting the global scope
    // }
    @Override
    ...
    public void visit(FunDec funDec, int level, boolean isAddr) {
        // Before diving into the function, set the current function context
        ...
        // Process the function body (if your language allows for function body declarations at this stage)
        if (funDec.body != null) {
...
// System.out.println("Visiting IfExp");
        // Visit the test expression to type-check it
            ...
            if (currentFunctionContext == null) {
                ...
                if (currentFunctionContext.result.typ == NameTy.VOID && !isNilOrNull(returnExp.exp)) {
                    ...
                    if (!areTypesCompatible(currentFunctionContext.result, returnExp.exp)) {
                        ...
                        System.out.println("currentFunctionContext.result: " + currentFunctionContext.result.toString());
                        System.out.println("returnExp: " + returnExp.toString());

//prints                // Check and print the type of returnExp if it's not null, otherwise print "null"
                        if (returnExp.getType() != null) {
                            System.out.println("returnExp.getType(): " + returnExp.getType().toString());
                        } else {
                            System.out.println("returnExp.getType(): null");
                        }
                        ...
                        if (returnExp.exp != null && returnExp.exp.getType() != null) {
                            System.out.println("returnExp.exp.getType(): " + returnExp.exp.getType().toString());
                        } else {
                            System.out.println("returnExp.exp.getType(): null");
                        }
...
System.out.println("Visiting SimpleVar: " + simpleVar.getName());
...
System.out.println("left: " + opExp.left.toString());
System.out.println("right: " + opExp.right.toString());
        ...
        // else {
        //     System.out.println("invalid case: right operand isNilOrNull");                  
        ...
        switch (opExp.op) {
            ...
            case OpExp.DIV:
                ...
                //         System.out.println("Valid case: Arithmetic operands are of the same type:\n\tleft: " + opExp.left.toString() + "\n\tright: " + opExp.right.toString());
                //     } else {
                //         System.out.println("left: " + isInteger(opExp.left));
                //         System.out.println("right: " + isInteger(opExp.right));
                        
                //         System.out.println("invalid case: Arithmetic operands are of NOT same type:\n\tleft: " + opExp.left.toString() + "\n\tright: " + opExp.right.toString());
                ...
                if (areTypesCompatible(intTy, opExp.left) && areTypesCompatible(intTy, opExp.right)) {
                    ...
                    System.out.println("left: " + areTypesCompatible(intTy, opExp.left));
                    System.out.println("right: " + areTypesCompatible(intTy, opExp.right));
            ...
            case OpExp.NE:
                ...
                if (areTypesCompatible(intTy, opExp.left) && areTypesCompatible(intTy, opExp.right)) {
                    ...
                    System.out.println("invalid case: both operands are of NOT same type");
...
System.out.println("Visiting IntExp: " + intExp.toString());
...
System.out.println("Visiting BoolExp: " + boolExp.toString());
...
private boolean areTypesCompatible(NameTy expected, Exp actual) {
    ...
    System.out.println("Actual instance class: " + actual.getClass().getSimpleName());

    if ((expected.typ == NameTy.INT) && isInteger(actual)) {
      System.out.println("Actual is IntExp or explicitly integer");
      return true;
    } else if ((expected.typ == NameTy.BOOL) && isBoolean(actual)) {
      System.out.println("Actual is BoolExp or explicitly integer");
      return true;
    }

    if (actual.getType() instanceof VarDec) {
        VarDec varDec = (VarDec) actual.getType();
        System.out.println("VarDec.typ.typ: " + varDec.typ.typ); // Print the type of the variable
        ...
        System.out.println("FunDec.result.typ: " + funDec.result.typ); // Print the return type of the function
    ...
    if (actual instanceof BoolExp || isBoolean(actual)) {
        System.out.println("Actual is BoolExp or explicitly boolean"); // Indicative print
    ...
    // For IntExp or explicitly integer expressions
        ...
        System.out.println("Actual is IntExp or explicitly integer"); // Indicative print
    ...
    // For Nil or null expressions, checking if expected is VOID
        ...
        System.out.println("Actual is Nil or null and expected is VOID"); // Indicative print
        return true;
        ...
        if (funcNode != null && funcNode.dec instanceof FunDec) {
            ...
            System.out.println("Function " + callExp.func + " not found in symbol table.");
        }
    } else if (actual instanceof VarExp) {
        System.out.println("actual is instance of VarExp");
        ...
        if (nodeType != null && nodeType.dec instanceof VarDec) {
            ...
            System.out.println("Variable " + varExp.variable.toString() + " not found in symbol table or not a VarDec.");
        }
        ...
        if (opExp.type != null) {
            ...
            System.out.println("OpExp type is null, indicating missing type evaluation.");
        ...
        System.out.println("Unexpected case encountered in areTypesCompatible");
    }
    return false;
}
